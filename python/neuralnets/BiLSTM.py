""" 
A bidirectional LSTM with optional CRF and character-based
presentation for NLP sequence tagging used for multi-task learning.
        ...
        for modelName in self.modelNames:
            ...
            if self.params['optimizer'].lower() == 'adam':
                ...
                opt = Adam(**optimizerParams)
            	  ...
            	  #kim lr=0.0005
                opt = Nadam(lr=0.0005, **optimizerParams)
            elif self.params['optimizer'].lower() == 'rmsprop': 
            	  #kim lr=0.0001
                opt = RMSprop(lr=0.001, **optimizerParams)
