...
log.basicConfig( filename = '/data/logs/Decovri/testMed.log' ,
...
if len(sys.argv) < 3:
    print ("Usage: python3 testMed.py modelPath portNumber")
    exit()
...
log.info( 'starting service_name=testMed with socket_host=%s socket_port=%s' % sock.getsockname() )
sock.listen(1)
...
log.info( "Job done for service_name=testMed" )
