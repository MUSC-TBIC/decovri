...
public class Duration extends Annotation {
  ...
  */  
   ...
   */
  public Drug getDrug() {
    if (Duration_Type.featOkTst && ((Duration_Type)jcasType).casFeat_drug == null)
      jcasType.jcas.throwFeatMissing("drug", "edu.musc.covid.type.Duration");
    return (Drug)(jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((Duration_Type)jcasType).casFeatCode_drug)));}
  ...
  public void setDrug(Drug v) {
    if (Duration_Type.featOkTst && ((Duration_Type)jcasType).casFeat_drug == null)
      jcasType.jcas.throwFeatMissing("drug", "edu.musc.covid.type.Duration");
    jcasType.ll_cas.ll_setRefValue(addr, ((Duration_Type)jcasType).casFeatCode_drug, jcasType.ll_cas.ll_getFSRef(v));}    
  }
