 ...
 * @generated */
public class Dosage_Type extends Annotation_Type {
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = Dosage.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.musc.covid.type.Dosage");
  ...
  public int getDrug(int addr) {
      ...
      jcas.throwFeatMissing("drug", "edu.musc.covid.type.Dosage");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public Dosage_Type(JCas jcas, Type casType) {
    super(jcas, casType);
