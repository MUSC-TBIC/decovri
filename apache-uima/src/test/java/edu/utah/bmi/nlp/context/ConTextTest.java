...
class ConTextTest {
    ...
    private static AnalysisEngineDescription conText;

    @BeforeAll
    public static void beforeAll() throws UIMAException {
        //conText = AnalysisEngineFactory.createEngineDescription(
        //        ConText.class ,
        //        ConText.PARAM_VERSION , "vUnitTest" );
