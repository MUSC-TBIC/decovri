...
class OpenNlpTokenizerTest {
    ...
    private static AnalysisEngineDescription openNlpTokenizer;

    @BeforeAll
    public static void beforeAll() throws UIMAException {
        //openNlpTokenizer = AnalysisEngineFactory.createEngineDescription(
        //        OpenNlpTokenizer.class ,
        //        OpenNlpTokenizer.PARAM_VERSION , "vUnitTest" );
    ...
    public void openNlpTokenizerTest( String documentText )
            throws ResourceInitializationException, UIMAException {

        mJcas.setDocumentText( documentText );

        // Process jcas
        //SimplePipeline.runPipeline( mJcas , openNlpTokenizer );
