...
class OMOP_CDM_CASConsumerTest {
    ...
    private static AnalysisEngineDescription omop_CDM_CASConsumer;

    @BeforeAll
    public static void beforeAll() throws UIMAException {
        //omop_CDM_CASConsumer = AnalysisEngineFactory.createEngineDescription(
        //        OMOP_CDM_CASConsumer.class ,
        //        OMOP_CDM_CASConsumer.PARAM_VERSION , "vUnitTest" );
    ...
    public void omop_CDM_CASConsumerTest( String documentText )
            throws ResourceInitializationException, UIMAException {

        mJcas.setDocumentText( documentText );

        // Process jcas
        //SimplePipeline.runPipeline( mJcas , omop_CDM_CASConsumer );
    ...
    public void test0000() {
        ...
        try {
        	omop_CDM_CASConsumerTest( contents );
