...
class AnnotatedTextWriterTest {
    ...
    private static AnalysisEngineDescription annotatedTextWriter;

    @BeforeAll
    public static void beforeAll() throws UIMAException {
        //annotatedTextWriter = AnalysisEngineFactory.createEngineDescription(
        //        AnnotatedTextWriter.class ,
        //        AnnotatedTextWriter.PARAM_VERSION , "vUnitTest" );
    ...
    public void annotateTextWriterTest( String documentText )
            throws ResourceInitializationException, UIMAException {

        mJcas.setDocumentText( documentText );

        // Process jcas
        //SimplePipeline.runPipeline( mJcas , annotatedTextWriter );
    ...
    public void test0000() {
        ...
        try {
        	annotateTextWriterTest( contents );
