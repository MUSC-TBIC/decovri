...
class XmlWriterTest {
    ...
    public void xmlWriterTest( String documentText )
            throws ResourceInitializationException, UIMAException {

        mJcas.setDocumentText( documentText );

        // Process jcas
        //SimplePipeline.runPipeline( mJcas , xmlWriter );
