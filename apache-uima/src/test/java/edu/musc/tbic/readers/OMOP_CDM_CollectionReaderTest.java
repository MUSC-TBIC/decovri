...
class OMOP_CDM_CollectionReaderTest {
    ...
    private static AnalysisEngineDescription omop_CDM_CollectionReader;

    @BeforeAll
    public static void beforeAll() throws UIMAException {
        //omop_CDM_CollectionReader = AnalysisEngineFactory.createEngineDescription(
        //        OMOP_CDM_CollectionReader.class ,
        //        OMOP_CDM_CollectionReader.PARAM_VERSION , "vUnitTest" );
    ...
    public void omop_CDM_CollectionReaderTest( String documentText )
            throws ResourceInitializationException, UIMAException {

        mJcas.setDocumentText( documentText );

        // Process jcas
        //SimplePipeline.runPipeline( mJcas , omop_CDM_CollectionReader );
    ...
    public void test0000() {
        ...
        try {
        	omop_CDM_CollectionReaderTest( contents );
