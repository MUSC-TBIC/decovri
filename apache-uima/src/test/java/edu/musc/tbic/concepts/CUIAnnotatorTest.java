...
class CUIAnnotatorTest {
    ...
    private static AnalysisEngineDescription cuiAnnotator;

    @BeforeAll
    public static void beforeAll() throws UIMAException {
        //cuiAnnotator = AnalysisEngineFactory.createEngineDescription(
        //        CUIAnnotator.class ,
        //        CUIAnnotator.PARAM_VERSION , "vUnitTest" );
    ...
    public void annotateCUIs( String documentText )
            throws ResourceInitializationException, UIMAException {

        mJcas.setDocumentText( documentText );

        // Process jcas
        //SimplePipeline.runPipeline( mJcas , cuiAnnotator );
