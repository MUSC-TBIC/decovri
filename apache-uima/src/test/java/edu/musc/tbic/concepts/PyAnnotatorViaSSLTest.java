...
class PyAnnotatorViaSSLTest {
    ...
    private static AnalysisEngineDescription pyAnnotatorViaSSL;

    @BeforeAll
    public static void beforeAll() throws UIMAException {
        //pyAnnotatorViaSSL = AnalysisEngineFactory.createEngineDescription(
        //        PyAnnotatorViaSSL.class ,
        //        PyAnnotatorViaSSL.PARAM_VERSION , "vUnitTest" );
    ...
    public void annotatePy( String documentText )
            throws ResourceInitializationException, UIMAException {

        mJcas.setDocumentText( documentText );

        // Process jcas
        //SimplePipeline.runPipeline( mJcas , pyAnnotatorViaSSL );
