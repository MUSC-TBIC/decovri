...
class RelAnnotatorTest {
    ...
    private static AnalysisEngineDescription relAnnotator;

    @BeforeAll
    public static void beforeAll() throws UIMAException {
        //relAnnotator = AnalysisEngineFactory.createEngineDescription(
        //        RelAnnotator.class ,
        //        RelAnnotator.PARAM_VERSION , "vUnitTest" );
    ...
    public void annotateRel( String documentText )
            throws ResourceInitializationException, UIMAException {

        mJcas.setDocumentText( documentText );

        // Process jcas
        //SimplePipeline.runPipeline( mJcas , relAnnotator );
