...
class UtilCovTest {
    ...
    private static AnalysisEngineDescription utilCov;

    @BeforeAll
    public static void beforeAll() throws UIMAException {
        //utilCov = AnalysisEngineFactory.createEngineDescription(
        //        UtilCov.class ,
        //        UtilCov.PARAM_VERSION , "vUnitTest" );
    ...
    public void annotateUtilCov( String documentText )
            throws ResourceInitializationException, UIMAException {

        mJcas.setDocumentText( documentText );

        // Process jcas
        //SimplePipeline.runPipeline( mJcas , utilCov );
